...
class PizzasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pizza" do
    assert_difference("Pizza.count") do
      post pizzas_url, params: { pizza: { image: @pizza.image, ingredients: @pizza.ingredients, name: @pizza.name } }
    end
  ...
  test "should update pizza" do
    patch pizza_url(@pizza), params: { pizza: { image: @pizza.image, ingredients: @pizza.ingredients, name: @pizza.name } }
